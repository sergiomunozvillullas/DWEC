...
function inicio(){
	let boton=document.getElementById("anyadir"); //localidad
	if ( document.addEventListener)
...
function nuevo(){
	let padre=document.getElementById("paises"); //localidades
	let vpais=document.getElementById("caja").value; //localidad
